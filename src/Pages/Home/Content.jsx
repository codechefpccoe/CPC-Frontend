...
const Content = () => {
  ...
  return (
    <div className="w-1/2 justify-center flex flex-col gap-6 px-8 dark:text-white z-[100] max-lg:px-4 max-lg:gap-3 max-md:w-3/4 max-md:text-center max-vs:w-[90%]">
