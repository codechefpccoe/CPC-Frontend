...
const HomeContainer = () => {
  return (
    <div className="flex w-full flex-1 px-16 -mt-8 dark:bg-[#181818] max-xl:mt-0 max-lg:px-8 max-md:flex-col-reverse max-md:justify-end max-md:items-center max-md:px-0 max-md:gap-8">
